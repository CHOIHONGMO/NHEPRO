...
<%
	...
	String domainName  = request.getAttribute("domainName") == null ? request.getParameter("domainName") : request.getAttribute("domainName").toString();
...
function init(){
	...
	var confmKey = "U01TX0FVVEgyMDE4MTEyNzEwMDIxMDEwODMyOTk="; //회사이름으로 받은 컨펌키 입력.
