...
<e:ui locale="${ses.countryCd}" lang="${ses.langCd}" dateFmt="${ses.dateFormat}">
    <script type="text/javascript">
        ...
        function init() {
            ...
            grid.cellClickEvent(function(rowIdx, colIdx, value) {
                ...
                if(colIdx == "USER_ID") {
                    ...
                    everPopup.openPopupByScreenId("OVNR0021", 800, 450, param);
                }
            });
        }
        ...
        function doSearch() {
            ...
            if(flag) {
                return EVF.alert("${OVNR0020_001}");
            }

            var store = new EVF.Store();
            if(!store.validate()) { return; }
            store.setGrid([grid]);
            store.load(baseUrl + "ovnr0020_doSearch.so", function() {
        ...
        function doDelete() {
            ...
            EVF.confirm("${msg.M0013 }", function () {
                ...
                store.load(baseUrl + "ovnr0020_doDelete.so", function () {
    ...
    <e:window id="OVNR0020" onReady="init" initData="${initData}" title="${fullScreenName}" breadCrumbs="${breadCrumb }">
