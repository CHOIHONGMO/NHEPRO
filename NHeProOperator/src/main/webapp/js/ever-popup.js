...
everPopup.openApprovalRequestIPopup = function(param){
    ...
    everPopup.openWindowPopup(url, 1100, 920, param, 'openApprovalRequestIPopup');
};
...
everPopup.openApprovalOrRejectPopup = function(params) {
    ...
    everPopup.openWindowPopup(url, 1250, 900, params, 'approvalOrRejectPopup');
};
...
everPopup.openContractChangeInformation = function(params) {
    var url = '/eversrm/nhepro/CCTR/CCTA0030/view.so';
