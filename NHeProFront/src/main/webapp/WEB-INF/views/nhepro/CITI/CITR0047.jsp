...
<e:ui locale="${ses.countryCd}" lang="${ses.langCd}" dateFmt="${ses.dateFormat}">
    <script>
        var grid;
        var baseUrl = "/nhepro/CITI/CITR0047/";
        ...
        function doSearch() {
            ...
            store.setGrid([grid]);
            store.load(baseUrl + "citr0047_doSearch.so", function () {
            });
        }
    ...
    <e:window id="CITR0047" onReady="init" initData="${initData}" title="${fullScreenName}">
