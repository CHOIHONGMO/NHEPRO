                ...
                if (this.getResponseMessage() == '1') {
             	...
             	// 개인정보 이용약관 미체크 한 사용자
                    ...
                    if (this.getResponseMessage() == null) {
                    	 store.load('/login.so', function (data) { doLoginProcess(this); } , false);
                    }
                }
            }, false);
        }
        ...
        function doLoginProcess(data){
        	...
        	if ( isLoginError ) {
                var resCode = data.getResponseCode()
                	, isNonUser = resCode == "LONG_TERM_NON_USER"
                ...
                <div class="row">
                    <div class="col-6 pl-0">
                        <div class="nav-wrap">
                            ...
                            <div class="btn-link">
                                <!-- <a class="" href="/session/viewContents/view.so?realUrl=/mainHtml/03_customer/03_notice_list.jsp">더보기</a> -->
                            ...
                            <div class="tab-content" id="myTabContent">
                                ...
                                <div class="tab-pane fade" id="bidding" role="tabpanel" aria-labelledby="bidding-tab">
                                    <ul>
                                        <c:forEach items="${cbdiList}" var="C">
                                            <li><a href="javascript:noticeCookieCheck2('${C.BUYER_CD}', '${C.BID_NUM}', '${C.BID_CNT}', '${C.BID_STATUS}', 'loginPopupNotice');"><span class="category">${C.ANN_ITEM_TITLE}</span><span class="title">${C.ANN_ITEM}</span><span class="date">${C.ANN_DATE}</span></a>                                        </li>
                                        </c:forEach>
                                    </ul>
                                </div>
                            </div>
                    ...
                    <div class="col-3">
                        ...
                        <%--<div class="row no-gutters">
                            <a class="card" href="#">
                                <p class="card-header">블록체인 인증</p>
                                <span>블록체인 등록/인증R</span>
                                <span class="icon"><i class="fas fa-chevron-right"></i></span>
                            </a>
                        </div>--%>
                    </div>
