...
public class TestTAXGUA {
	...
	public static String composeXML(String templatePath, String docCode)
	{
		...
		String	head_mesg_type  ="TAXGUA";			/*[필수]	 문서코드*/
		...
		/* 보증기관 */   
		String  bond_orga_name  ="테스트보증기관명";	/*[선택]	보증기관명*/	        
		String  bond_orga_iden  ="G2B등록코드";			/*[선택]	G2B등록코드*/	
		String  bond_orga_addn  ="조달청등록코드";		/*[선택]	조달청등록코드*/	
		String  bond_orga_ceo  ="보증기관 대표자성명";			/*[선택]	대표자성명*/ 
		
		/* 공공기관 */                                                                                                                                                                                                                                      
		String  govn_orga_name  ="테스트공공기관명";	/*[선택]	공공기관명*/	
		String  govn_orga_iden  ="G2B등록코드";			/*[선택]	G2B등록코드*/       
		String  govn_orga_addn  ="조달청등록코드";		/*[선택]	조달청등록코드*/       
		String  govn_ownr_name  ="공공기관 대표자성명";	/*[선택]	대표자성명*/     
			
		/* 작성일자 */
		String  docu_issu_date  ="20070918";			/*[선택]	작성일자*/  
			
		/* 업무구분 */
		String  busi_clas_code  ="T";					/*[선택]	업무구분코드*/  
		String  busi_clas_name  ="테스트";				/*[선택]	업무구분내용*/  		
			
		/* 보증서(증권)번호 */
		String  bond_numb_text  ="34355423";			/*[선택]	보증서(증권)번호*/

		/* 보증내용 */
		String  bond_penl_text  ="천원";				/*[선택]	보증금액(한글)*/
		String  bond_penl_amnt  ="1000";				/*[선택]	보증금액(숫자)*/
		String  penl_curc_code  ="WON";					/*[선택]	보증금액/통화코드*/
		String  bond_begn_date  ="20070918";			/*[선택]	보증시작일*/
		String  bond_fnsh_date  ="20080918";			/*[선택]	보증만료일*/
		String  bond_prem_amnt  ="3000";				/*[선택]	보험료*/
		String  prem_curc_code  ="WON";					/*[선택]	보험료/통화코드*/
		String  bond_pric_rate  ="30";					/*[선택]	보증금율*/
		String  appl_orga_name  ="계약자/상호";			/*[선택]	계약자/상호*/
		String  appl_orps_divs  ="p";					/*[선택]	계약자/사업자/주민등록번호구분*/
		String  appl_orps_iden  ="5501011111111";		/*[선택]	계약자/사업자/주민등록번호 */
		String  appl_ownr_name  ="계약자/대표자성명";	/*[선택]	계약자/대표자성명*/
		String  cred_orga_name  ="채권자/기관명";		/*[선택]	채권자/기관명*/
		String  cred_orps_divs  ="P";					/*[선택]	채권자/사업자/주민등록번호구분*/
		String  cred_orps_iden  ="6701011111111";		/*[선택]	채권자/사업자/주민등록번호*/
		String  bond_hold_name  ="채권자/채권자명";		/*[선택]	채권자/채권자명*/

		/* 보증계약(납세의무내용) */
		String  cont_name_text  ="세목";		/*[선택]	세목*/
		String  cont_main_amnt  ="1000";		/*[선택]	세액*/
		String  cont_curc_code  ="WON";			/*[선택]	세액/통화코드*/
		String  cont_numb_text  ="2345";		/*[선택]	수입인증번호*/
		String  cont_good_text  ="품명";		/*[선택]	품명*/
		String  cont_volm_amnt  ="1";			/*[선택]	수량*/
		String  cont_begn_date  ="20070917";	/*[선택]	납기기간/납기시작일*/
		String  cont_fnsh_date  ="20071017";	/*[선택]	납기기간/납기만료일*/

		/* 특기사항 */
		String  spcl_cond_text  ="특기사항 없음";	/*[선택]	특기사항*/

		/* 특별약관 */
		String  spcl_prov_text  ="특별약관 없음";	/*[선택]	특별약관*/

		/* 보증문 */
		String  bond_stat_text  ="보증문 없음";		/*[선택]	보증문*/

		/* 발행자 */
		String  issu_addr_txt1  ="서울시 ";		/*[선택]	주소1*/
		String  issu_addr_txt2  ="중구 중림동"; /*[선택]	주소2*/
		String  issu_orga_name  ="테스트 상호"; /*[선택]	상호*/
		String  issu_ownr_name  ="대표자성명";	/*[선택]	대표자성명*/
		String  issu_dept_name  ="부서";		/*[선택]	대리인/부서(대리점)*/
		String  issu_dept_ownr  ="대리인/성명"; /*[선택]	대리인/성명*/
		String  chrg_name_text  ="담당자/성명"; /*[선택]	담당자/성명*/
		String  chrg_phon_text  ="021111111";	/*[선택]	담당자/전화*/
		String  chrg_faxs_text  ="021111112";	/*[선택]	담당자/Fax 번호*/

		/* 비고 */
		String  gene_note_text  = "비고 없음";	/*[선택]	비고*/
		...
		try{
			...
			if(		
				...
				&&  dataToXml.setData("cont_good_text", cont_good_text)
				&&  dataToXml.setData("cont_volm_amnt", cont_volm_amnt)
				...
				)
			{
				...
				FileWriteUtil.genFileCreate( "D:/KICA_SGIxLinker/samples/document/sampleTAXGUA.xml", xmlDoc);
			}else{
				System.out.println(dataToXml.getErrorMsg());
			}
		}catch(Exception _e){
	...
	public static void parseXML(String templatePath, String docCode, String xmlDoc)
	{
		...
		try{					
			...
			/* Begin of 업무구분 */
			String busi_clas_code = xmlToData.getData("busi_clas_code");/*[선택]	업무구분코드*/ 
			String busi_clas_name = xmlToData.getData("busi_clas_name");/*[선택]	업무구분내용*/  
			/* End of 업무구분 */
			...
			/* Begin of 보증계약(납세의무내용) */
			String cont_name_text = xmlToData.getData("cont_name_text");/*[선택]	세목*/
			String cont_main_amnt = xmlToData.getData("cont_main_amnt");/*[선택]	세액*/ 
			String cont_curc_code = xmlToData.getData("cont_curc_code");/*[선택]	세액/통화코드*/ 
			String cont_numb_text = xmlToData.getData("cont_numb_text");/*[선택]	수입인증번호*/ 
			String cont_good_text = xmlToData.getData("cont_good_text");/*[선택]	품명*/  
			String cont_volm_amnt = xmlToData.getData("cont_volm_amnt");/*[선택]	수량*/
			String cont_begn_date = xmlToData.getData("cont_begn_date");/*[선택]	납기기간/납기시작일*/ 
			String cont_fnsh_date = xmlToData.getData("cont_fnsh_date");/*[선택]	납기기간/납기만료일*/ 
			/* End of 보증계약(납세의무내용) */
			...
			System.out.println("cont_good_text=" + cont_good_text);
			System.out.println("cont_volm_amnt=" + cont_volm_amnt);
