...
<e:ui locale="${ses.countryCd}" lang="${ses.langCd}" dateFmt="${ses.dateFormat}">
	...
	<script type="text/javascript">
	    ...
	    function doSearch() {
	        ...
	        store.setGrid([grid]);
	        store.load(baseUrl + 'ccbr0020_doSearch.so', function() {
	...
	<e:window id="CCBR0020" initData="${initData}" onReady="init" title="${fullScreenName }" breadCrumbs="${breadCrumb }">
		...
		<e:buttonBar id="buttonBar" align="right" width="100%" title="SMS수수료청구금액">
		...
		<e:buttonBar id="itemBtnBar" align="right" width="100%" title="SMS수수료 내역" />
