...
var ConfigObject = {
	...
	STORAGELIST					: ["web","hdd","token","mobile"],	//지원 스토리지 리스트 ( 순서대로 UI 그림, JSON)
	...
	STORAGESELECT				: "web",	//인증서 선택창 초기화 할 때, 기본 선택 스토리지
	...
	BROWSER_NOTICE_SHOW			: false, // 브라우저 저장소 클릭시 안내 이미지 출력 여부 true, false
	
	eOption						: false, //true or false
	kOption						: "",	// "", "dream"

	//Client version
	WinClientVersion 			: "1.0.0.29",
	MacClientVersion 			: "1.0.0.18",
	...
	DS_PKI_CERT_PATH			: {"GPKI":[], "NPKI":['INIPASS','nh nonghyup'], "MPKI":[], "PPKI":[]},
