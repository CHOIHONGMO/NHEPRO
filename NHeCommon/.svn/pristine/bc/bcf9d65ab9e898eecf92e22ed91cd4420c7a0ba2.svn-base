 ...
 ******************************************************************************
 * </pre>
 * @File Name : MTUA0010_Mapper.java
 * @date 2013. 07. 22.
 * @version 1.0
 */

@Repository
public interface MTUA0010_Mapper {
	 ...
	 */
	List<Map<String, Object>> mtua0010_doSearchUser(Map<String, String> param);
	
	List<Map<String, Object>> mtua0010_doSearchUserEmp(Map<String, String> param); //2022.10.24 개인근로자(파트너스 )추가 
	...
	//2022.11.30 개인근로자 파트너스 추가
	Map<String, Object> doGetUserTVUR(Map<String, String> param);
	...
	void doSaveIssue_TVUR(Map<String, String> generalForm);
	...
	int existsUserInformation_TVUR(Map<String, String> param);
	
	int createUserInformation_TVUR(Map<String, String> generalForm);
	...
	//2023.01.05 개인근로자 로직 추가
	int CheckUserInfoPassWordSame_EMP(Map<String, String> generalForm);
	...
	void doDeleteUserInfoBS(Map<String, String> generalForm);
