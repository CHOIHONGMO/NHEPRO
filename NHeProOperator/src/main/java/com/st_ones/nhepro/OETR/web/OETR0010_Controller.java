...
import com.st_ones.nhepro.OETR.service.OETR0010_Service;
 ...
 ******************************************************************************
 * </pre>
 * @File Name : OETR0010_Controller.java
 * @date 2013. 07. 22.
 * @version 1.0
 */
...
public class OETR0010_Controller extends BaseController {

    @Autowired private MessageService msg;

    @Autowired private OETR0010_Service oetr0010_Service;

    /**
     * 화면명 : 개인정보
     * 처리내용 : 사용자의 개인정보(전화번호, E-Mail, 비밀번호 등)를 관리하는 화면
     * 경로 : 운영사 > My Page > My Page > 개인정보
     */
    @RequestMapping(value="/OETR0010/view")
    public String OETR0010(EverHttpRequest req) throws Exception {
        ...
        req.setAttribute("form", oetr0010_Service.selectUser(param));
        ...
        return "/nhepro/OETR/OETR0010";
    }

    @RequestMapping(value = "/oetr0010_saveUser")
    public void oetr0010_saveUser(EverHttpRequest req, EverHttpResponse resp) throws Exception {
        ...
        String strMsg = oetr0010_Service.saveUser(formData);
        ...
        if (userType.equals("O")) { // 운영사
            baseInfo.setDateFormat(oetr0010_Service.getUserDateFormat(formData).get("USER_DATE_FORMAT_VALUE"));
            baseInfo.setNumberFormat(oetr0010_Service.getUserDateFormat(formData).get("USER_NUMBER_FORMAT_VALUE"));
        }
