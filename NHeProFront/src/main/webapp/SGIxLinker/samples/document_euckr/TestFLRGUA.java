...
public class TestFLRGUA {
	...
	public static String composeXML(String templatePath, String docCode)
	{
		...
		String	head_mesg_type  ="FLRGUA";			/*	[필수]	 문서코드	*/
		String	head_mesg_name  ="이행하자보증서";	/*	[필수]	 문서명	*/
		...
		String	head_titl_name  ="이행하자보증서";	/*	[필수]	 문서개요	*/
		...
		/* 부수계약 */
		String morg_begn_date ="20060509";			/*	[선택]	  하자담보책임시작일 */
		String morg_fnsh_date ="20070509";			/*	[선택]	  하자담보책임만료일 */
		String cont_perf_date ="20061009";			/*	[선택]	  계약이행기일	  */
		/* 특기사항 */
		...
		try{
				...
				)
			{
				...
				FileWriteUtil.genFileCreate( "D:/KICA_SGIxLinker/samples/document/sampleFLRGUA.xml", xmlDoc);
			}else{
				System.out.println(dataToXml.getErrorMsg());
			}
		}catch(Exception _e){
