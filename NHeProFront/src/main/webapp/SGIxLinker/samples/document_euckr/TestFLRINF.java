...
public class TestFLRINF {
	...
	public static String composeXML(String templatePath, String docCode)
	{
		...
		String	head_mesg_type  ="FLRINF";			/*	[필수]	 문서코드	*/
		String	head_mesg_name  ="하자정보통보서";	/*	[필수]	 문서명	*/
		...
		String	head_titl_name  ="하자정보통보서";	/*	[필수]	 문서개요	*/
		...
		/* 하자정보 */								
		String	morg_begn_date  ="20060101";		/*	[필수]	 하자보수책임시작일	*/
		String	morg_fnsh_date  ="20061231";		/*	[필수]	 하자보수책임종료일	*/
		String	morg_term_text  ="365";				/*	[필수]	 하자보수책임기간	*/
		String	morg_pric_rate  ="12.5";			/*	[필수]	 하자보증금율	*/
		String	morg_cnfm_code  ="Y";				/*	[선택|필수]	 무하자확인 Y:하자없음, N:하자있음 (하자보수책임시작일로 부터 30일이상 경과시 필수항목) */
		String	morg_cnfm_date  ="20060101";		/*	[선택|필수]	 무하자확인일 (하자보수책임시작일로 부터 30일이상 경과시 필수항목) */
		...
		try{
			...
			if(		
				...
				&&  dataToXml.setData("morg_cnfm_code", morg_cnfm_code)
				&&  dataToXml.setData("morg_cnfm_date", morg_cnfm_date)
				/* End of 하자정보 */		
				...
				)
			{
				...
				FileWriteUtil.genFileCreate( "D:/KICA_SGIxLinker/samples/document/sampleFLRINF.xml", xmlDoc);
			}else{
				System.out.println(dataToXml.getErrorMsg());
			}
		}catch(Exception _e){
			...
			if(xmlToData.getErrorCode() != 0)
			{
				...
				return;
				 ...
				 String hist_bond_numb = xmlToData.getData("hist_bond_numb");
				   /* End of 주요계약정보 */         
				   /* Begin of 하자정보 */	          
				 String morg_begn_date = xmlToData.getData("morg_begn_date");
				 String morg_fnsh_date = xmlToData.getData("morg_fnsh_date");
				 String morg_term_text = xmlToData.getData("morg_term_text");
				 String morg_pric_rate = xmlToData.getData("morg_pric_rate");
				 String morg_cnfm_code = xmlToData.getData("morg_cnfm_code");
				 String morg_cnfm_date = xmlToData.getData("morg_cnfm_date");
				   /* End of 하자정보 */		  
				   /* Begin of 채권자 정보 */	
				...
				System.out.println("morg_begn_date=" + morg_begn_date);
				System.out.println("morg_fnsh_date=" + morg_fnsh_date);
				System.out.println("morg_term_text=" + morg_term_text);
				System.out.println("morg_pric_rate=" + morg_pric_rate);
				System.out.println("morg_cnfm_code=" + morg_cnfm_code);
				System.out.println("morg_cnfm_date=" + morg_cnfm_date);
