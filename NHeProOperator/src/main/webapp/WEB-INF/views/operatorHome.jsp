...
<e:ui locale="${ses.countryCd}" lang="${ses.langCd}" dateFmt="${ses.dateFormat}">
    ...
    <title>FIRSTePro - ${ses.userNm}님 환영합니다.</title>
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            if ('${ses.grantedAuthCd}' == 'PF0123') {
                EVF.alert("연채채권 회수계획을 등록하세요.\n정상로그인은 최종승인 이후에 진행 할 수 있습니다.");
                openScreenToNewTab("TM901295", "연채채권 회수계획 등록", "/siis/A02/A02_010/view.so", "");
            }
        });
            ...
            if (confirm('${msg.M0039}')) {
                ...
                store.load('/logout.so', function () {
                    ...
                    if ('${everSslUseFlag}' == 'true') {
                        location.href = "https://${eversrmSystemDomainUrl}:${eversrmSystemDomainPort}";
                    } else {
                        location.href = '/';
                    }
        ...
        function goHome() {
            ...
            if ('${everSslUseFlag}' == 'true') {
                // location.href = "https://${eversrmSystemDomainUrl}:${eversrmSystemDomainPort}/home.so";
        ...
        function openUserInfo() {
            var param = {};
            if ('${everSslUseFlag}' == 'true') {
                window.open('${realDomainUrl}' + '/nhepro/OETR/OETR0010/view.so?popupFlag=true', "사용자정보", "width=700,height=320,scrollbars=yes,resizeable=no,left=150,top=150");
            } else {
                var url = '/nhepro/OETR/OETR0010/view.so?popupFlag=true';
                everPopup.openWindowPopup(url, 700, 370, null, 'openUserInfo');
            }
        }

        function openScreenToNewTab(id, text, value, e, outUrl, popup) {

            if (outUrl == '1' && popup == '1') {
                everPopup.openWindowPopup(value, 1100, 600, {}, id);
                return;
            } else if (popup == '1') {
                everPopup.openWindowPopup(value, 1100, 600, {}, id);
                return;
        ...
        function openTab(id, text, value) {
            ...
            store.load('/common/util/' + 'menuClickSave.so', function () {
                ...
                if (this.getResponseCode() == '1') {
                    ...
                    if (text == '사용자정보') {
                        ...
                        if ('${everSslUseFlag}' == 'true') {
                            value = 'https://${eversrmSystemDomainUrl}:${eversrmSystemDomainPort}' + value;
                        } else {
                        }
                    }
                    ...
                    $('#e-main-tab').append($('<iframe id="ui-tabs-' + id + '" frameborder="0" scrolling="auto" marginheight="0" marginwidth="0" width="100%" height="100%" src="' + value + '?tmpl_menu_cd=' + id + '&screen_name=' + screenName + '" style="padding: 0; margin: 0; height: 100%;"></iframe>'));
                    $('#e-main-tab').tabs('refresh');
    ...
    <e:window id="e-body" width="100%" height="100%" onReady="init" initData="${initData}" padding="0 0 0 0">
        ...
        <div id="contentsBody" class="ui-layout-center" style="width: 100%;">
            <div id="e-main-tab" class="e-main-tab" style="height: 100%; width: 100%; cursor: default !important;">
                ...
                --%>
                <ul>
                    <li><a href="#ui-tabs-main" title="HOME">고객의 소리(VOC)</a></li>
                </ul>
                <iframe id="ui-tabs-main" src="/nhepro/OETR/OETR0040/view.so" frameborder="0" scrolling="auto" marginheight="0" marginwidth="0" width="100%" height="100%" style="padding: 0; margin: 0; height: 100%; width: 100%;"></iframe>
            </div>
        </div>
        ...
        <div class="ui-layout-west">
            <div class="ui-layout-center">
                <%-- 로고 --%>
                <div style="height: 63px; width: 100%; cursor:pointer; background: url(/images/nhepro/common/logo_firstepro.png) 50% 50% no-repeat;" title="로고" onclick="goHome();"></div>
                <%-- Line --%>
                ...
                <div style="height:100%; width:74px; float: left; background-color: #134e80;">
                    <div style="width: 100%; text-align: center; user-select: none; background-color: #134e80;">
                        ...
                        <c:if test="${codeExposureFlag eq 'true'}">
                            <div style="position: absolute; bottom: 25px; left: 8px; cursor: help;" title="Open EverUX API Docs" onclick="openAPI();">
                                <div style="border-radius: 3px; background: #ddd; border: 1px solid #aaa; color: #000; font-size: 9px; font-weight: bold; padding: 3px 6px 3px 3px;">
                                    open API
                                </div>
                            </div>
                        </c:if>
                ...
                <div style="height:100%; margin: 0; padding: 0; overflow:hidden; float: left; position: relative;">
                    ...
                    <%--<div class="helpdesk-container">
                        ...
                        <div class="helpdesk-contents">
                            <div style="line-height: 4px; display: inline-block;">
                                <p class="helpdesk-subTitle"><span style="color: #dc2d34;">-</span> 업무시간 : 08:30~17:30
                                </p>
                                <p class="helpdesk-subTitle"><span style="color: #dc2d34;">-</span> 사용문의 : 02-6959-2625
                                </p>
                            </div>
                        </div>
                    </div>--%>
