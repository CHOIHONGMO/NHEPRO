...
CKEDITOR.editorConfig = function( config ) {
    ...
    config.extraPlugins = 'econtInfo,pastebase64';
    ...
    config.contentsCss = 'ul { font-size:12px; margin-top: 0px; margin-bottom: 0px; list-style: none; padding: 0px; } li a {  color: black; text-decoration: none; cursor: default; } body { font-size: 13px; font-family: "굴림"; } input, textarea, div.contentEditable { background-color: #ffd9ff; outline: 1px dashed #dc2c34; border: 0; } input[contenteditable]:hover {background-color: #efe24b; outline: 2px dashed #9e072f;}'
    // config.contentsCss = ["/js/ckeditor/default_contents.css"];
    config.toolbar = [
        ['Source','-','Preview'],
