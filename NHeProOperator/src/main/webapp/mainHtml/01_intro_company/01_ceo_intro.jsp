...
<div class="wrap sub_page">
    ...
    <div class="contents contents_intro contents_intro_company contents_intro_summary">
        <ul class="tabs">
            ...
            <li class="active"><a href="/mainHtml/01_intro_company/01_ceo_intro.jsp"><span>CEO 인사말</span></a></li>
        ...
        <p class="path"><span class="one">HOME</span><span class="two">회사소개</span><span
                class="three current">CEO인사말</span></p>

        <section class="top">
            <img alt="DSP MRO 회사 개요" src="/images/ymro/sub/01_ceo_intro.png">
        </section>
