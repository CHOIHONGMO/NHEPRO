...
<e:ui locale="${ses.countryCd}" lang="${ses.langCd}" dateFmt="${ses.dateFormat}">
	<script type="text/javascript">
        ...
        function search() {
            ...
            store.setGrid([grid1]);
            store.load(baseUrl + 'MTUB0030/doSearch.so', function() {
	...
	<e:window id="MTUB0030" onReady="init" initData="${initData}" title="${fullScreenName}" breadCrumbs="${breadCrumb }">
		...
		<e:gridPanel id="grid1" name="grid1" width="100%" height="fit" readOnly="${param.detailView}" gridType="${_gridType}" />
