...
<e:ui locale="${ses.countryCd}" lang="${ses.langCd}" dateFmt="${ses.dateFormat}">
    <script type="text/javascript">
        ...
        function doSave() {
            ...
            if(EVF.isEmpty(EVF.V("START_DATE"))) { return EVF.alert("${OETR0031_003 }"); }
            if(EVF.isEmpty(EVF.V("NOTICE_CONTENTS"))) { return EVF.alert("${OETR0031_002 }"); }

            EVF.confirm("${msg.M0021 }", function () {
                store.doFileUpload(function () {
                    store.load(baseUrl + "oetr0031_doSave.so", function () {
                        var pNoticeNum = this.getParameter("NOTICE_NUM");
                        EVF.alert(this.getResponseMessage(), function () {
                            // location.href = baseUrl + "OETR0031/view.so?NOTICE_NUM=" + pNoticeNum + "&detailView=false";
                            if (opener != null) {
                                opener.doSearch();
                            }
        ...
        function doDelete() {
            ...
            EVF.confirm("${msg.M0013 }", function () {
                store.load(baseUrl + "oetr0031_doDelete.so", function () {
                    EVF.alert(this.getResponseMessage(), function() {
                        if (opener != null) {
                            opener.doSearch();
                        }
        ...
        function doClear() {
            EVF.confirm("${OETR0031_005 }", function () {
                location.href = baseUrl + "OETR0031/view.so?NOTICE_NUM=&detailView=false";
            });
        }
    ...
    <e:window id="OETR0031" onReady="init" initData="${initData}" title="${fullScreenName }" breadCrumbs="${breadCrumb }">
