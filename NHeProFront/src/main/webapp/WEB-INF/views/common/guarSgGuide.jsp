...
<e:ui locale="${ses.countryCd}" lang="${ses.langCd}" dateFmt="${ses.dateFormat}">
    ...
    <e:window id="guarSgGuide" onReady="init" initData="${initData}" title="서울보증 전자신청안내" breadCrumbs="${breadCrumb }">
        <e:searchPanel id="form" useTitleBar="false" title="" labelWidth="100%" width="100%" columnCount="1">
	        ...
	        <e:field>
	        	...
	        	<e:text style="font-weight: bold; font-size: 14px; color: #222222">전자보증 신청 후 서울보증 사이트에서의 계약번호는 농협 전자구매시스템의 계약상세 화면에서 전자보증으로 신청하신 계약건에 대한 "계약번호"가 아닌 "전자보증신청번호" 입니다.</e:text><e:br/>
	        	<e:text style="font-weight: bold; font-size: 14px; color: #222222">전자보증 신청 후 서울보증 사이트에서 신청하신 보증내용을 불러오기 및 수기입력 시 계약번호를 입력하는 경우 "전자보증신청번호"를 입력하시기 바랍니다.</e:text><e:br/>
