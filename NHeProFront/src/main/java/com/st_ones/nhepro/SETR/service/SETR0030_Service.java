...
import com.st_ones.nhepro.SETR.SETR0030_Mapper;
 ...
 ******************************************************************************
 * </pre>
 * @File Name : SETR0030_Service.java
 * @date 2018. 01. 30.
 * @version 1.0
 */

@Service(value = "SETR0030_Service")
public class SETR0030_Service extends BaseService {

    @Autowired MessageService msg;
    @Autowired SETR0030_Mapper setr0030_mapper;
     ...
     */
    public List<Map<String, Object>> setr0030_doSearch(Map<String, String> param) {
        return setr0030_mapper.setr0030_doSearch(param);
    }

    // 삭제
    @Transactional(propagation = Propagation.REQUIRED, rollbackFor = Exception.class)
    public String setr0030_doDelete(List<Map<String, Object>> gridDatas) throws Exception {
        for(Map<String, Object> gridData : gridDatas) {
            setr0030_mapper.setr0030_doDelete(gridData);
        }
     ...
     */
    public Map<String, Object> setr0031_doSearchNoticeInfo(Map<String, String> param) throws Exception {
        Map<String, Object> rtnMap = setr0030_mapper.setr0031_doSearchNoticeInfo(param);
        ...
        if (param.get("detailView").equals("true")) {
            ...
            setr0030_mapper.setr0031_doSaveCount(rtnMap);
        }
    ...
    // 저장
    @Transactional(propagation = Propagation.REQUIRED, rollbackFor = Exception.class)
    public Map<String, String> setr0031_doSave(Map<String, String> formData) throws Exception {
        ...
        if(noticeNum.equals("")) {
            ...
            setr0030_mapper.setr0031_doInsert(formData);
        }
        else {

            largeTextService.saveLargeText(noticeTextNum, formData.get("NOTICE_CONTENTS"));

            setr0030_mapper.setr0031_doUpdate(formData);
        }
    ...
    // 삭제
    @Transactional(propagation = Propagation.REQUIRED, rollbackFor = Exception.class)
    public String setr0031_doDelete(Map<String, String> formData) throws Exception {
        Map<String, Object> param = new HashMap<>();

        param.put("NOTICE_NUM", formData.get("NOTICE_NUM"));

        setr0030_mapper.setr0030_doDelete(param);
