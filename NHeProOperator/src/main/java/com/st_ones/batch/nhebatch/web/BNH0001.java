...
@Service
public class BNH0001 extends EverJob {
    ...
    public void execute(JobExecutionContext context) throws JobExecutionException {
        ...
        if (super.isAllowedToRunBatch(context)) {
            ...
            try {
                msg = bnh0001_service.doExecService(new HashMap<String, String>());
                jobRlt = "S";
            } catch (Exception e) {
            	...
            	if( telNums != null ) {
	            	for (String telNum : telNums) {
	                    try {
	    	                ...
	    	                smsMap.put("CONTENTS", "[전자구매Batch] 아리오피스 조직 및 인사(BNH0001) I/F시 오류가 발생");
                ...
                try {
                    ...
                    logData.put("JOB_ID", "BNH0001");
                    logData.put("JOB_NM", "아리오피스 조직 및 인사");
                    logData.put("JOB_KEY", "");
