 ...
 ******************************************************************************
 * </pre>
 * @File Name : MSRA0010_Mapper.java
 * @date 2013. 07. 22.
 * @version 1.0
 */

public interface MSRA0010_Mapper {
	...
	void doInsertScreenManagement(Map<String, Object> gridData);

	void doUpdateScreenManagement(Map<String, Object> gridData);

	void doDeleteScreenManagement(Map<String, Object> gridData);
	...
	void updateHelpInfo(Map<String, String> formData);

	void deleteHelpInfo(Map<String, String> formData);
