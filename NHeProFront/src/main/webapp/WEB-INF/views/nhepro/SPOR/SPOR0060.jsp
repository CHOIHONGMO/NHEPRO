...
<e:ui locale="${ses.countryCd}" lang="${ses.langCd}" dateFmt="${ses.dateFormat}">
    <script type="text/javascript">
        ...
        function doSearch() {
            ...
            store.load(baseUrl + "spor0060_doSearch.so", function() {
        ...
        function doUpdate() {
            ...
            // 작성중(50), 반려(500)
            if( "50" != PROGRESS_CD && "500" != PROGRESS_CD ) {
                return EVF.alert("${SPOR0060_006}");
            }
    ...
    <e:window id="SPOR0060" onReady="init" initData="${initData}" title="${fullScreenName}" breadCrumbs="${breadCrumb }">
