            ...
            $.post(url + "doSearchInfo.so", $('input').serialize(), function (data) {
                if(sFlag == 'I') {
                    if(data) {
                        ...
                        html+= "<div class='col-desc' style='color:red; font-weight: bold;'>"+ data.USER_ID +"</div>";
	                ...
	                // kcbCallbackFunction({RSLT_MSG: "본인인증 완료", RSLT_NAME: "박준용"});
                    ...
                    <div class="row">
                        <div class="col-5">
                            ...
                            <div class="row">
                                ...
                                <div class="col-desc">
                                    <input type="text" id="I_USER_NM" name="I_USER_NM" class="form-control" title="example" placeholder="">
                                </div>
                            </div>
                            <div class="row">
                        ...
                        <div class="offset-1 col-5">
                            <p class="title"><i class="fas fa-dot-circle"></i>비밀번호 찾기</p>
                            <div class="row">
                                <div class="border-top pt-4"></div>
                            ...
                            <div class="row">
                                <div class="col-title">사용자명</div>
                                <div class="col-desc">
                                    <input type="text" id="P_USER_NM" name="P_USER_NM" class="form-control" title="example" placeholder="">
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-title">E-mail</div>
