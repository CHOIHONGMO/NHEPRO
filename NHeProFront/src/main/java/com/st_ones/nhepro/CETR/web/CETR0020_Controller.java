...
import com.st_ones.nhepro.CETR.service.CETR0020_Service;
 ...
 ******************************************************************************
 * </pre>
 * @File Name : CETR0020_Controller.java
 * @date 2013. 07. 22.
 * @version 1.0
 */
...
public class CETR0020_Controller extends BaseController {

    @Autowired private CETR0020_Service cetr0020_service;
     ...
     */
    @RequestMapping(value="/CETR0020/view")
    public String CETR0020(EverHttpRequest req) {
        ...
        return "/nhepro/CETR/CETR0020";
    }

    // 조회
    @RequestMapping(value = "/cetr0020_doSearch")
    public void cetr0020_doSearch(EverHttpRequest req, EverHttpResponse resp) throws Exception {
        resp.setGridObject("grid", cetr0020_service.cetr0020_doSearch(req.getFormData()));
    }
    ...
    @RequestMapping(value="/CETR0021/view")
    public String CETR0021(EverHttpRequest req) throws Exception {
        ...
        if(!noticeNum.equals("")) {
            ...
            formData = cetr0020_service.cetr0021_doSearchNoticeInfo(param);
