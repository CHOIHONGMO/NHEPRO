	...
	<div id="ML_container" style="width:418px; float:left;"><!-- ML_container : S -->
		<div class="ML_content" style="width:418px;float:left;"><!-- ML_content : S -->
			...
			<div id='ESignWindow'></div>
				<div class="ML_cp_AD" style="display:;"><img src="UI/images/ML5_banner.png" alt="매직라인4"></div>
				<div id="ML_dp_01" class="ML_sub_tit">인증서 저장 위치 선택
					<span class="ML_sub_tit_link">
						<span class="btn_cell_right">
							<p class="hp_btn"><button type="button" id='btn_browser_manual' style="width:160px;"><span><img src="UI/images/icon_help.png" alt="브라우저 인증서 사용방법">브라우저 인증서 사용방법</span></button></p>
						</span>
					</span>
				</div>
