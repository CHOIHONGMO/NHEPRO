...
var DS_SmartCertCommonParams ={
		...
		requestWindowURL:'https://www.smartcert.kr/nonPlugin/requestSmartCert.sc',
...
//대체 가능 선택 라이브러리
{
	...
	if (window.jQuery) {  
		...
		document.write('<script type="text/javascript" src="https://www.smartcert.kr/SmartCertWeb/CP/js/jquery-1.10.2.js"></script>');
	}
	
	// dialog library
	document.write('<script type="text/javascript" src="https://www.smartcert.kr/SmartCertWeb/CP/js/SmartcertUI-1.1.js"></script>');
	// dialog library css
	document.write('<link type="text/css" rel="stylesheet" href="https://www.smartcert.kr/SmartCertWeb/CP/css/Smartcert_jq_1.1.css">');
}
