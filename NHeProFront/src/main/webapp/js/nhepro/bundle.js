...
front.common = (function () {
	...
	var inputFile = function () {
		$('.custom-file-input').on('change', function () {
			...
			$(this).siblings('.custom-file-label').addClass('selected').html(fileName).css({
				'color':'#333',
				'border-color':'#333'
			})
		})
	...
	var commonHandler = function () {
		$(document).ready(function () {
			...
			tabBtn.click(function(){
				...
				if (index == 0) {
					tabCont.eq(index).css("height", "941px");
				} else if (index == 1) {
					tabCont.eq(index).css("height", "1020px");
				} else if (index == 2) {
					tabCont.eq(index).css("height", "790px");
				} else if (index == 3) {
					tabCont.eq(index).css("height", "941px");
				} else if (index == 4) {
					tabCont.eq(index).css("height", "750px");
				}
	...
	Datepicker.prototype = {
		...
		place: function(){
			...
			var left = offset.left - appendOffset.left,
				top = offset.top - appendOffset.top + 5;
...
!function(a){a.fn.datepicker.dates.kr = {
