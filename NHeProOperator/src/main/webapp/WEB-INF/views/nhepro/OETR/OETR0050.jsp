...
<e:ui locale="${ses.countryCd}" lang="${ses.langCd}" dateFmt="${ses.dateFormat}">
    <script type="text/javascript">
            ...
            grid.cellClickEvent(function(rowIdx, colIdx) {
                ...
                if(colIdx == "SUBJECT") {
                    param = {
                        ...
                        detailView: (grid.getCellValue(rowIdx, "POPUP_FLAG")=="1")?true:false,
                        popupFlag: true
                    };
        ...
        function doSearch() {
            ...
            store.setGrid([grid]);
            store.load(baseUrl + "oetr0050_doSearch.so", function() {
    ...
    <e:window id="OETR0050" initData="${initData}" onReady="init" title="${fullScreenName}" breadCrumbs="${breadCrumb }">
