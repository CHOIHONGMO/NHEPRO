...
@Service
public class BNH0012 extends EverJob {
    ...
    public void execute(JobExecutionContext context) throws JobExecutionException {
        ...
        if (super.isAllowedToRunBatch(context)) {
            ...
            bnh0012_service = SpringContextUtil.getBean(BNH0012_Service.class);

            String msg = "";
            int totalCount = 0;

            try {
                msg = bnh0012_service.doExecService(new HashMap<String, String>());
                jobRlt = "S";
            } catch (Exception e) {
            	...
            	if( telNums != null ) {
	            	for (String telNum : telNums) {
	                    try {
	    	                ...
	    	                smsMap.put("CONTENTS", "[전자구매Batch] 사용자 및 부서 SYNC(BNH0012) I/F시 오류가 발생");
                ...
                try {
                    ...
                    logData.put("JOB_ID", "BNH0012");
                    logData.put("JOB_NM", "사용자 및 부서 SYNC");
                    logData.put("JOB_KEY", "");
