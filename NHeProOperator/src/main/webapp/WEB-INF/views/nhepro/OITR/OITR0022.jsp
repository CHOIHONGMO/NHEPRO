...
<e:ui locale="${ses.countryCd}" lang="${ses.langCd}" dateFmt="${ses.dateFormat}">
    <script>
        var baseUrl = "/nhepro/OITR/OITR0022/";
        var grid;
        var APmultiYn;
        var signStatus;
        ...
        function doSearch() {
            ...
            store.setGrid([grid]);
            store.load(baseUrl + "oitr0022_doSearch.so", function () {
            });
        }
    ...
    <%-- IM03_009 --%>
    <e:window id="OITR0022" onReady="init" initData="${initData}" title="${fullScreenName}">
        ...
        <e:buttonBar id="buttonTopBottom" align="right" width="100%" title="${OITR0022_CAPTION1 }">
        ...
        <e:searchPanel id="form" title="${form_CAPTION_N }" labelWidth="${labelWidth}" width="100%" columnCount="3" useTitleBar="false">
            <e:row>
                ...
                <e:field>
                    <e:select id="ITEM_STATUS" name="ITEM_STATUS" value="${formData.ITEM_STATUS}" options="${itemStatusOptions}" width="${form_ITEM_STATUS_W}" disabled="${form_ITEM_STATUS_D}" readOnly="${form_ITEM_STATUS_RO}" required="${form_ITEM_STATUS_R}" placeHolder=""  maskType="${form_ITEM_STATUS_MT}"/>
                </e:field>
                <%-- 최종수정정보 --%>
            ...
            <e:row>
                ...
                <e:field colSpan="5">
                    <e:search id="ITEM_SPEC" name="ITEM_SPEC" value="${formData.ITEM_SPEC}" width="${form_ITEM_SPEC_W}" maxLength="${form_ITEM_SPEC_M}" onIconClick="_getSpecList" disabled="${form_ITEM_SPEC_D}" readOnly="${form_ITEM_SPEC_RO}" required="${form_ITEM_SPEC_R}"  placeHolder="${OITR0022_004}" maskType="${form_ITEM_SPEC_MT}" />
                </e:field>
            </e:row>
            <e:row>
                <%-- 제조사 --%>
        ...
        <e:searchPanel id="searchPanel2" title="${OITR0022_CAPTION2}" labelWidth="${labelWidth}" width="100%" height="150px" columnCount="3" useTitleBar="true">
            <e:row>
                <e:field colSpan="2">
