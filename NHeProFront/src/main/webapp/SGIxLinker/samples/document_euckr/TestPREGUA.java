...
public class TestPREGUA {
	...
	public static String composeXML(String templatePath, String docCode)
	{
		...
		String	head_mesg_type  ="PREGUA";			/*	[필수]	 문서코드	*/
		String	head_mesg_name  ="이행선금보증서";	/*	[필수]	 문서명	*/
		...
		String	head_titl_name  ="이행선금보증서";	/*	[필수]	 문서개요	*/
		...
		/* 부수계약 */		
		String cont_paym_amnt ="10000";					/*	[선택]	  선금액	*/        
		String paym_curc_code ="WON";					/*	[선택]	  선금액/통화코드	*/
		String cont_paym_date ="20060509";				/*	[선택]	  지급예정일	*/
		String cont_perf_date ="20070509";				/*	[선택]	  계약이행기일	*/
		/* 특기사항 */
		...
		try{
			...
			if(		
				...
				/* End of 보증계약(주) */
				/* Begin of 부수계약 */
				&&  dataToXml.setData("cont_paym_amnt", cont_paym_amnt)
				&&  dataToXml.setData("paym_curc_code", paym_curc_code)
				&&  dataToXml.setData("cont_paym_date", cont_paym_date)
				&&  dataToXml.setData("cont_perf_date", cont_perf_date)
				/* End of 부수계약 */
				/* Begin of 특기사항 */
				...
				)
			{
				...
				FileWriteUtil.genFileCreate( "D:/KICA_SGIxLinker/samples/document/samplePREGUA.xml", xmlDoc);
			}else{
				System.out.println(dataToXml.getErrorMsg());
			}
		}catch(Exception _e){
	...
	{	
		try{	
			...
			String cont_fnsh_date = xmlToData.getData("cont_fnsh_date");
			  /* End of 보증계약(주) */         
			  /* Begin of 부수계약 */           
			String cont_paym_amnt = xmlToData.getData("cont_paym_amnt");
			String paym_curc_code = xmlToData.getData("paym_curc_code");
			String cont_paym_date = xmlToData.getData("cont_paym_date");
			String cont_perf_date = xmlToData.getData("cont_perf_date");
			  /* End of 부수계약 */             
			  /* Begin of 특기사항 */           
			...
			System.out.println("cont_paym_amnt=" + cont_paym_amnt);
			System.out.println("paym_curc_code=" + paym_curc_code);
			System.out.println("cont_paym_date=" + cont_paym_date);
			System.out.println("cont_perf_date=" + cont_perf_date);
