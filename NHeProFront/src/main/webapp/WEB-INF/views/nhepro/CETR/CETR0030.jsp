...
<e:ui locale="${ses.countryCd}" lang="${ses.langCd}" dateFmt="${ses.dateFormat}">
    <script type="text/javascript">
        ...
        function init() {
            ...
            grid.cellClickEvent(function(rowIdx, colIdx) {
                ...
                if(colIdx == "SUBJECT") {
                    ...
                    everPopup.openPopupByScreenId("CETR0031", 1500, 730, param);
        ...
        function doSearch() {
            ...
            store.setGrid([grid]);
            store.load(baseUrl + "cetr0030_doSearch.so", function() {
    ...
    <e:window id="CETR0030" initData="${initData}" onReady="init" title="${fullScreenName}" breadCrumbs="${breadCrumb }">
