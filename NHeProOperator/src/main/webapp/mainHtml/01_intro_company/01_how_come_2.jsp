    ...
    <script>
        $(document).ready(function() {
            ...
            var mapContainer = document.getElementById('map'), // 지도를 표시할 div
                mapOption = {
                    center: new kakao.maps.LatLng(37.517538, 126.903755), // 지도의 중심좌표
                    level: 4 // 지도의 확대 레벨
                };
            ...
            // 주소로 좌표를 검색합니다
            geocoder.addressSearch('경기도 화성시 동탄대로 635(영천동) SH타임스퀘어1차 911호', function(result, status) {
                ...
                if (status === kakao.maps.services.Status.OK) {
                    ...
                    var infowindow = new kakao.maps.InfoWindow({
                        content: '<div style="width:150px;text-align:center;padding:6px 0;">지사</div>'
                    });
    ...
    <div class="wrap sub_page">
        ...
        <div class="contents contents_intro contents_intro_company contents_how_come">
            ...
            <ul class="tabs tabs_2depth tabs_col2">
                <li><a href="/mainHtml/01_intro_company/01_how_come.jsp">본사</a></li>
                <li class="active"><a href="#">지사</a></li>
            </ul>
                ...
                <section class="info clearfix">
                    <div>
                        <div class="desc_wrap clearfix">
                            ...
                            <p class="desc">경기도 화성시 동탄대로 635(영천동) SH타임스퀘어1차 911호</p>
                        </div>
                        <div class="desc_wrap clearfix">
                            <span class="title">전화</span>
                            <p class="desc">031 - 376 - 3415</p>
                        </div>
                    </div>
                    <div>
                        <div class="desc_wrap desc_wrap_mt clearfix">
                            <span class="title">팩스</span>
                            <p class="desc">031 - 376 - 3416</p>
                        </div>
                    </div>
                </section>
