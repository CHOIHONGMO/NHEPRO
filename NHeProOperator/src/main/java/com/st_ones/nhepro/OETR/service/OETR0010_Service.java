...
import com.st_ones.nhepro.OETR.OETR0010_Mapper;
 ...
 ******************************************************************************
 * </pre>
 * @File Name : OETR0010_Service.java
 * @date 2018. 01. 30.
 * @version 1.0
 */

@Service(value = "OETR0010_Service")
public class OETR0010_Service extends BaseService {

    @Autowired private MessageService msg;

    @Autowired private OETR0010_Mapper oetr0010_Mapper;
    ...
    public HashMap<String, String> selectUser(Map<String, String> param) throws UserInfoNotFoundException {
        ...
        if (userType.equals("O")) {
            rtn = oetr0010_Mapper.selectUser(param);
        // 협력사, 고객사
        } else {
            rtn = oetr0010_Mapper.selectUserCS(param);
        }
        return rtn;
    }
    ...
    public String saveUser(Map<String, String> formData) throws Exception {
        ...
        // 운영사
        if (userType.equals("O")) {
            oetr0010_Mapper.doUpdate(formData);
            // 협력사, 고객사
        } else {
            oetr0010_Mapper.doUpdateCS(formData);
        }
        return msg.getMessage("0031");
    }

    public HashMap<String, String> getUserDateFormat(Map<String, String> formData) throws Exception {
        return oetr0010_Mapper.getDateFormatValue(formData);
    }
