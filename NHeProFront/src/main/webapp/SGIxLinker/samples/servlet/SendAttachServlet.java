...
public class SendAttachServlet extends HttpServlet 
{
    		...
    		throws ServletException, IOException
    {
		...
		try{
			...
			System.out.println("SendServlet:" + e.toString());
			e.printStackTrace();
	...
	public String composeXML()
	{
		...
		String  head_mesg_send  ="A120870175500"
		...
		// 매핑 정보 파일, XML 탬플릿 정보 파일
		DataToXml datatoxml = new DataToXml("d:/KICA_SGIxLinker/templates/", "CONINF");
