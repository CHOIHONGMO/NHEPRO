...
<div class="wrap sub_page">
    ...
    <div class="contents contents_intro contents_intro_company contents_intro_history">
        ...
        <ul class="tabs tabs_2depth tabs_col4">
            ...
            <li class="active"><a href="/mainHtml/01_intro_company/01_intro_history_1980.jsp">1980's</a></li>
        </ul>

        <div class="tabs_contents intro_history_1980s">
            <section class="box_history">
                ...
                <div class="list_box list_box_history">
                    ...
                    <dl class="list">
                        <dt class="title"><em>연도</em>1988</dt>
                        <dd class="desc"><em>내용</em>06월 택배 및 배송사업 개시</dd>
                        <dd class="img"><img src="/images/ymro/sub/intro_history_1988_06.png"
                                             alt="1988년 06월 택배 및 배송사업 개시"></dd>
                    </dl>
                    <dl class="list">
                        <dt class="title"><em>연도</em>1984</dt>
                        <dd class="desc"><em>내용</em>01월 서울 외 11개 지역 출장소 개설</dd>
                        <dd class="img"><img src="/images/ymro/sub/intro_history_1984_01.png"
                                             alt="1984년 01월 서울 외 11개 지역 출장소 개설"></dd>
                    </dl>
                    <dl class="list">
                        <dt class="title"><em>연도</em>1983</dt>
                        <dd class="desc"><em>내용</em>07월 운송알선 사업면허 취득, 사업개시</dd>
                        <dd class="desc"><em>내용</em>07월 용마유통(주) 설립</dd>
                    </dl>
                </div>
            </section>
        </div>
