package com.st_ones.nhepro.MOBILE_NHPT.web;
...
import com.st_ones.nhepro.MOBILE_NHPT.service.MobilePT_Service;
 ...
 */
@Controller
@RequestMapping(value = "/nhepro/MOBILE_NHPT")
public class MobilePT_Controller extends BaseController {

    @Autowired
    private MessageService msg;

    @Autowired
    private MobilePT_Service mobile_service;
     ...
     * 화면설명 : 약관동의
     */
    @RequestMapping(value = "/MPTAGG_010/view")
    public String MPTAGG_010(EverHttpRequest req) {
        return "/nhepro/MOBILE_NHPT/MPTAGG_010";
    }

    /**
     * 화면설명 : 약관동의 후 정보입력
     */
    @RequestMapping(value = "/MPTAGG_020/view")
    public String MPTAGG_020(EverHttpRequest req) {
        ...
        return "/nhepro/MOBILE_NHPT/MPTAGG_020";
    }

    /**
     * 화면설명 : 담당자검색
     */
    @RequestMapping(value = "/MPTAGG_030/view")
    public String MPTAGG_030(EverHttpRequest req) throws Exception {
        Map<String, String> form = EverString.replaceInjection(req.getParamDataMap());

        req.setAttribute("form", form);
        return "/nhepro/MOBILE_NHPT/MPTAGG_030";
    }

    /**
     * 화면설명 : 담당자검색 - 조회
     */
    @RequestMapping(value = "/MPTAGG_030_doSearch")
    public void MPTAGG_030_doSearch(EverHttpRequest req, EverHttpResponse resp) throws Exception {
        List<Map<String, Object>> deptUserList = mobile_service.MPTAGG_030_doSearch(req.getParamDataMap());
     ...
     * 화면설명 : 신청완료
     */
    @RequestMapping(value = "/MPTAGG_040/view")
    public String MPTAGG_040(EverHttpRequest req) {
        return "/nhepro/MOBILE_NHPT/MPTAGG_040";
    }
     ...
     * 화면설명 : 아이디/비밀번호 찾기
     */
    @RequestMapping(value = "/MPTIDPW_010/view")
    public String MPTIDPW_010(EverHttpRequest req) {
        req.setAttribute("pageFlag", req.getParameter("pageFlag"));
        return "/nhepro/MOBILE_NHPT/MPTIDPW_010";
    }

    /**
     * 메인화면 - 회원가입(인증번호확인)
     */
    @RequestMapping("/MPTIDPW_010_doSearch")
    public void MPTIDPW_010_doSearch(EverHttpRequest req, EverHttpResponse resp) throws Exception {
        Map<String, String> reqMap = req.getParamDataMap();
        Map<String, String> userInfo = mobile_service.MPTIDPW_010_doSearch(reqMap);
     ...
     * 화면설명 : 아이디 찾기
     */
    @RequestMapping(value = "/MPTIDPW_020/view")
    public String MPTIDPW_020(EverHttpRequest req) {
        req.setAttribute("USER_ID", req.getParameter("USER_ID"));

        return "/nhepro/MOBILE_NHPT/MPTIDPW_020";
    }

    /**
     * 화면설명 : 비밀번호 찾기
     */
    @RequestMapping("/MPTIDPW_010_doSendPw")
    public void MPTIDPW_010_doSendPw(EverHttpRequest req, EverHttpResponse resp) throws Exception {
        Map<String, String> reqMap = req.getParamDataMap();
        Map<String, String> userInfo = mobile_service.MPTIDPW_010_doSearch(reqMap);
        ...
        if (userInfo != null) {
            ...
            mobile_service.MPTIDPW_010_Update(userInfo);

            // PW 이력관리
            userInfo.put("REG_IP_ADDR", EverString.getClientIP());
            mobile_service.MPTIDPW_010_InsertPW(userInfo);
     ...
     * 화면설명 : 비밀번호 찾기
     */
    @RequestMapping(value = "/MPTIDPW_030/view")
    public String MPTIDPW_030(EverHttpRequest req) {
       // req.setAttribute("EMAIL", req.getParameter("EMAIL"));
    	req.setAttribute("CELL_NUM", req.getParameter("CELL_NUM"));
        return "/nhepro/MOBILE_NHPT/MPTIDPW_030";
    }

    /**
     * 화면설명 : 90일 경과 비밀번호 변경 화면
     */
    @RequestMapping(value = "/MPTIDPW_040/view")
    public String MPTIDPW_040(EverHttpRequest req) {
        req.setAttribute("USER_ID", req.getParameter("USER_ID"));
        return "/nhepro/MOBILE_NHPT/MPTIDPW_040";
    }

    /**
     * 화면설명 : 90일 경과 비밀번호 변경
     */
    @RequestMapping(value = "/MPTIDPW_040_resetPassword")
    public void MPTIDPW_040_resetPassword(EverHttpRequest req, EverHttpResponse resp) throws Exception {
        req.setAttribute("USER_ID", req.getParameter("USER_ID"));
        ...
        // PW 2회 중복체크 / 변경
        reqMap.put("PASSWORD", EverEncryption.getEncryptedUserPassword(reqMap.get("PASSWORD")));
        Boolean pwFlag = mobile_service.MPTIDPW_040_resetPassword(reqMap);

        Map<String, String> responseMap = new HashMap<>();
        if (pwFlag) {
            // PW 이력관리
            reqMap.put("REG_IP_ADDR", EverString.getClientIP());
            mobile_service.MPTIDPW_010_InsertPW(reqMap);
     ...
     * mobileHome - 부서식 조회
     */
    @RequestMapping(value = "/mobileHome_subFormList")
    public void mobileHome_subFormList(EverHttpRequest req, EverHttpResponse resp) throws Exception {
        List<Map<String, Object>> list = mobile_service.mobileHome_subFormList(req.getParamDataMap());
     ...
     * 화면설명 : 모바일 공지사항 상세화면
     */
    @RequestMapping(value = "/MPTECM_060/view")
    public String MPTECM_060(EverHttpRequest req) throws Exception {
        ...
        return "/nhepro/MOBILE_NHPT/MPTECM_060";
    }
