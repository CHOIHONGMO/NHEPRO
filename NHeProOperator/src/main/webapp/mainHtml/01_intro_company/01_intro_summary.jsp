...
<div class="wrap sub_page">
    ...
    <!--content-->
    <div class="contents contents_intro contents_intro_company contents_intro_summary">
        <ul class="tabs">
            <!--탭바 클릭됬을 경우 class="active" 추가-->
            <li><a href="/mainHtml/01_intro_company/01_ceo_intro.jsp"><span>CEO 인사말</span></a></li>
            <li class="active"><a href="/mainHtml/01_intro_company/01_intro_summary.jsp"><span>회사개요</span></a></li>
        ...
        <p class="path"><span class="one">HOME</span><span class="two">회사소개</span><span
                class="three current">회사개요</span></p>

        <section class="top">
            <img alt="용마로지스 회사 개요" src="/images/ymro/sub/01_intro_summary.png">
        </section>
