...
CKEDITOR.editorConfig = function (config) {
    ...
    config.contentsCss = 'ul { font-size:12px; margin-top: 0px; margin-bottom: 0px; list-style: none; padding: 0px; } li a {  color: black; text-decoration: none; cursor: pointer; } input,textarea,div.contentEditable { background-color: #ffd9ff; outline: 1px dashed #dc2c34; border: 0; }';
