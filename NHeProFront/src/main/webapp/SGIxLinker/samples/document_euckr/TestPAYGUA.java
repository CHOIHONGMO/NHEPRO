...
public class TestPAYGUA {
	...
	public static String composeXML(String templatePath, String docCode)
	{
		...
		String	head_mesg_type  ="PAYGUA";			/*	[필수]	 문서코드	*/
		String	head_mesg_name  ="이행지급보증서";	/*	[필수]	 문서명	*/
		...
		String	head_titl_name  ="이행지급보증서";	/*	[필수]	 문서개요	*/
		...
		try{
				...
				)
			{
				...
				FileWriteUtil.genFileCreate( "D:/KICA_SGIxLinker/samples/document/samplePAYGUA.xml", xmlDoc);
			}else{
				System.out.println(dataToXml.getErrorMsg());
			}
		}catch(Exception _e){
