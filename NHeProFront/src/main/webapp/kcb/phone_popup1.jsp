...
<script>
	function jsSubmit(){
		...
		var form1 = document.kcbResultForm;
		form1.target = "auth_popup";
		form1.submit();
	}
</script>
</head>
<body onload="jsSubmit();">
...
<TABLE border="0" cellpadding="3" width="100%">
		...
		<form name="form1" action="phone_popup2.jsp" method="post">
			<table>
				...
				<tr>
					<td>요청사이트명</td>
					<td>
						<input type="text" name="SITE_NAME" maxlength="20" size="24" value="농협정보시스템">
					</td>
				</tr>
				<tr>
	...
	<form name="kcbResultForm" method="post" action="phone_popup2.jsp">
		<input type="hidden" name="CP_CD" value="V45030000000"/>
		<input type="hidden" name="SITE_NAME" value="농협정보시스템"/>
