...
public class FileAttachService extends BaseService {
    ...
    public static synchronized String getUUID() throws InterruptedException {
        Thread.sleep(2);
    ...
    public List<Map<String, Object>> getIVAPFilesInfo(String BUYER_CD, String AP_NUM) throws Exception {
        HashMap<String, String> hashMap = new HashMap<String, String>();
        hashMap.put("BUYER_CD", BUYER_CD);
        hashMap.put("AP_NUM", AP_NUM);
        return fileAttachMapper.getIVAPFilesInfo(hashMap);
    }
    ...
    public String getDecUUID(String uuid) {
        HashMap<String, String> hashMap = new HashMap<String, String>();
        hashMap.put("UUID", uuid);
        return fileAttachMapper.getDecUUID(hashMap);
    }

    public Map<String, String> getFileInfo(String uuid, String uuid_seq) {
        HashMap<String, String> hashMap = new HashMap<String, String>();
        hashMap.put("UUID", uuid);
        hashMap.put("UUID_SQ", uuid_seq);
        hashMap.put("GATE_CD", "100");
        return fileAttachMapper.getFileInfo(hashMap);
    }
    
    public Map<String, String> getContInfo(String contNum, String contCnt) {
        HashMap<String, String> hashMap = new HashMap<String, String>();
        hashMap.put("CONT_NUM", contNum);
        hashMap.put("CONT_CNT", contCnt);
        hashMap.put("GATE_CD", "100");
        return fileAttachMapper.getContInfo(hashMap);
    }
    
    public Map<String, String> getApInfo(String apNum) {
        HashMap<String, String> hashMap = new HashMap<String, String>();
        hashMap.put("AP_NUM", apNum);
        hashMap.put("GATE_CD", "100");
        return fileAttachMapper.getApInfo(hashMap);
    }
    ...
    public String getFileInfosForSingleApprovalForm(String bizType, String uuid) throws Exception {
        ...
        String imageDomainName = PropertiesManager.getString("eversrm.system.imageDomainName");
...
//			fileObjMap.put("TABLE_NM", "STOCFILE");
//			fileAttachMapper.deleteBinaryFile(fileObjMap);
//		}
        }
    }
    ...
    public List<Map<String, Object>> getECCMList(Map<String, String> param) {
        return fileAttachMapper.getECCMList(param);
    }

    public void updateFileInfo(HashMap<String, String> fileSaveInfo) {
        fileAttachMapper.updateFileInfo(fileSaveInfo);
    }
    
    public Map<String, String> getTagrgetFile(String uuid, String uuid_seq) {
        HashMap<String, String> hashMap = new HashMap<String, String>();
        hashMap.put("UUID", uuid);
        hashMap.put("UUID_SQ", uuid_seq);
        hashMap.put("GATE_CD", "100");
        return fileAttachMapper.getTagrgetFile(hashMap);
    }
    
    public int upsComplete(Map<String, String> param) {
        return fileAttachMapper.upsComplete(param);
    }    
}