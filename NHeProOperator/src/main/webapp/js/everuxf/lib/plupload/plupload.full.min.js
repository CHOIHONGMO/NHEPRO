...
!function (e, t) {
    ...
    function a(n) {
        for (var i = 0; i < n.length; i++) {
            for (var r = e, o = n[i], a = o.split(/[.\/]/),
                     u = 0; u < a.length - 1; ++u)r[a[u]] === t && (r[a[u]] = {}), r = r[a[u]];
            r[a[a.length - 1]] = s[o]
        }
    }
    ...
    i(u, [], function () {
        ...
        var e = function (t, n) {
            for (var i = ["source", "scheme", "authority", "userInfo", "user", "pass", "host", "port", "relative", "path", "directory", "file", "query", "fragment"],
                     r = i.length, o = {http: 80, https: 443}, a = {},
                     s = /^(?:([^:\/?#]+):)?(?:\/\/()(?:(?:()(?:([^:@]*):?([^:@]*))?@)?([^:\/?#]*)(?::(\d*))?))?()(?:(()(?:(?:[^?#\/]*\/)*)()(?:[^?#]*))(?:\\?([^#]*))?(?:#(.*))?)/,
                     u = s.exec(t || ""); r--;)u[r] && (a[i[r]] = u[r]);
            if (!a.scheme) {
            ...
            if (r = new e, r.init(n), 65496 === r.SHORT(0)) {
                ...
                return r.init(null), {
                    headers: i, restore: function (e) {
                        ...
                        for (var t = [], n = 0,
                                 r = i.length; r > n; n++)i[n].name === e.toUpperCase() && t.push(i[n].segment);
                        return t
                    }, set: function (e, t) {
                        var n = [], r, o, a;
            ...
            return a = new n, s = {
                ...
                init: function (e) {
                    ...
                    if (t = i(c.exifIFD, s.exif), t.ExifVersion && "array" === e.typeOf(t.ExifVersion)) {
                        for (var n = 0,
                                 r = ""; n < t.ExifVersion.length; n++)r += String.fromCharCode(t.ExifVersion[n]);
                        t.ExifVersion = r
                    }
                    return t
                }, GPS: function () {
        ...
        var t = {
            init: function (e) {
                function t(e) {
                    for (var t = "",
                             n = 0; n < e.length; n++)t += ("" !== t ? "|" : "") + e[n].title + " | *." + e[n].extensions.replace(/,/g, ";*.");
                    return t
                }
            ...
            o.each(e.runtimes.split(/\s*,\s*/), function (t) {
                ...
                s.push(function (n) {
                    ...
                    s.onready = function () {
                        ...
                        // drag&drop 기능이 true일 경우만 파일추가가 가능하도록 변경 ('18.2.14 shlee)
                        // console.log('r.getOption("dragdrop"): ', r.getOption('dragdrop'));
                        if(r.getOption('dragdrop')) {
                            r.addFile(this.files)
                        }
