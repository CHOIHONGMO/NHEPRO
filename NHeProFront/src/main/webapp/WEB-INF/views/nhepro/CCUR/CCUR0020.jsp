...
<e:ui locale="${ses.countryCd}" lang="${ses.langCd}" dateFmt="${ses.dateFormat}">
    ...
    <script type="text/javascript">
        ...
        var gridT; <%-- var gridM; var gridB; var gridDP; var gridA; --%>
        var addParam = [];
        var activeGrid;
        var activeRow;
        var activeDeptCd;
        ...
        function init() {
            ...
            gridT.cellClickEvent(function(rowIdx, colIdx, value) {
                ...
                if(colIdx == "DEPT_CD") {
                    ...
                    if(gridT.getCellValue(rowIdx, 'DEPT_CD') == ""){
                        ...
                        store.setGrid([gridM]);
                        store.load(baseUrl + 'ccur0020_doSearchM.so', function() {
                        ...
                        if(!EVF.isEmpty(gridT.getCellValue(rowIdx, 'DEPT_CD'))) {
                            ...
                            store.setGrid([gridA]);
                            store.load(baseUrl + 'ccur0020_doSearchAccount.so', function () {
            ...
            gridM.cellClickEvent(function(rowIdx, colIdx, value) {
                ...
                if(colIdx == "DEPT_CD") {
                    ...
                    if(gridM.getCellValue(rowIdx, 'DEPT_CD') == ""){
                        ...
                        store.setGrid([gridB]);
                        store.load(baseUrl + 'ccur0020_doSearchB.so', function() {
            ...
            gridB.cellClickEvent(function(rowIdx, colIdx, value) {
                ...
                if(colIdx == "DEPT_CD") {
                    ...
                    if(gridB.getCellValue(rowIdx, 'DEPT_CD') == ""){
                        ...
                        store.load(baseUrl + 'ccur0020_doSearchDP.so', function() {
            ...
            gridM.addRowEvent(function() {
                if(EVF.V("M_PARENT_DEPT_CD") == ""){ return EVF.alert("${CCUR0020_003}"); }
            ...
            gridB.addRowEvent(function() {
                if(EVF.V("B_PARENT_DEPT_CD") == ""){ return EVF.alert("${CCUR0020_003}"); }
            ...
            gridDP.addRowEvent(function() {
                if(EVF.V("DP_PARENT_DEPT_CD") == ""){ return EVF.alert("${CCUR0020_003}"); }
        ...
        function doSearch() {
            ...
            store.setGrid([gridT]);
            store.load(baseUrl + 'ccur0020_doSearch.so', function() {
        ...
        function doSave() {
            ...
            EVF.confirm("${msg.M0021 }", function () {
                var store = new EVF.Store();
                store.setParameter("radioVal", "R1");
                <%--
                store.setGrid([gridT, gridM, gridB, gridDP]);
                ...
                store.load(baseUrl + 'ccur0020_doSave.so', function() {
        ...
        function doSaveAcc() {
            ...
            EVF.confirm("${msg.M0021 }", function () {
                ...
                store.load(baseUrl + 'ccur0020_doSaveAcc.so', function() {
                    EVF.alert(this.getResponseMessage(), function() {
                        gridA.delAllRow();
                        store = new EVF.Store();
                        store.setParameter("DEPT_CD", activeDeptCd);
        ...
        function doDelAcc() {
            ...
            EVF.confirm("${msg.M0013 }", function () {
                ...
                store.setGrid([gridA]);
                store.getGridData(gridA, 'sel');
                store.load(baseUrl + 'ccur0020_doDelAcc.so', function() {
                    EVF.alert(this.getResponseMessage(), function() {
                        gridA.delAllRow();
                        store = new EVF.Store();
                        store.setParameter("DEPT_CD", activeDeptCd);
    ...
    <e:window id="CCUR0020" onReady="init" initData="${initData}" title="${fullScreenName}" breadCrumbs="${breadCrumb }">
        <e:searchPanel id="form" title="${msg.M9999 }" columnCount="2" labelWidth="${labelWidth }" useTitleBar="false" onEnter="doSearch">
            <e:row>
                ...
                <e:field>
                    ...
                    <e:inputText id="CUST_NM" name="CUST_NM" value="${ses.companyNm} " width="100%" maxLength="${form_CUST_NM_M}" disabled="${form_CUST_NM_D}" readOnly="${form_CUST_NM_RO}" required="${form_CUST_NM_R}"/>
                </e:field>
        ...
        <e:panel id="leftPanel" height="385px" width="50%">
            ...
            <e:text style="float: left; line-height: 27px; font-size: 14px; font-weight: bold;">${CCUR0020_LV1}</e:text>
        ...
        <e:panel id="rightPanel" height="385" width="49%">
            ...
            <e:text style="float: left; line-height: 27px; font-size: 14px; font-weight: bold;">${CCUR0020_LV2}</e:text>
        ...
        <e:panel id="leftPanelB" height="fit" width="50%">
            ...
            <e:text style="float: left; line-height: 27px; font-size: 14px; font-weight: bold;">${CCUR0020_LV3}</e:text>
            <e:gridPanel id="gridB" name="gridB" gridType="${_gridType}" width="100%" height="330px" readOnly="${param.detailView}"/>
        </e:panel>
        ...
        <e:panel id="rightPanelB" height="fit" width="49%">
            ...
            <e:text style="float: left; line-height: 27px; font-size: 14px; font-weight: bold;">${CCUR0020_LV4}</e:text>
            <e:gridPanel id="gridDP" name="gridDP" gridType="${_gridType}" width="100%" height="330px" readOnly="${param.detailView}"/>
        </e:panel>

        <e:buttonBar id="buttonBarAcc" title="${CCUR0020_002}" align="right" width="100%">
