...
<e:ui locale="${ses.countryCd}" lang="${ses.langCd}" dateFmt="${ses.dateFormat}">
        ...
        function doSave() {
            ...
            if(EVF.isNotEmpty(presentPass)) {
                if (newPassCheck1.trim() == "" || newPassCheck2.trim() == "") {
                    pwValid();
                    return EVF.alert("${OETR0010_003}");
                }

                if(newPassCheck1 != newPassCheck2) {
                    pwValid();
                    return EVF.alert("${OETR0010_004}");
                }
            }
            ...
            EVF.confirm("${msg.M0021 }", function () {
                store.load(baseUrl + "oetr0010_saveUser.so", function () {
    ...
    <e:window id="OETR0010" onReady="init" initData="${initData}" title="${fullScreenName}" breadCrumbs="${breadCrumb }">
        <e:title title="${OETR0010_TITLE1}" depth="1" />
        ...
        <e:title title="${OETR0010_TITLE2}" depth="1" />
