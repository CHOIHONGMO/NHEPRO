...
<e:ui locale="${ses.countryCd}" lang="${ses.langCd}" dateFmt="${ses.dateFormat}">
    <script>
        var grid;
        var baseUrl = "/nhepro/CITI/CITR0060/";
...
//                }
        ...
        function doSearch() {
            ...
            store.setGrid([grid]);
            store.load(baseUrl + "citr0060_doSearch.so", function () {
        ...
        function doSave() {
            ...
            EVF.confirm("${msg.M0021 }", function () {
                ...
                store.load(baseUrl + "citr0060_doSave.so", function () {
    ...
    <%-- IM03_007 --%>
    <e:window id="CITR0060" onReady="init" initData="${initData}" title="${fullScreenName}">
