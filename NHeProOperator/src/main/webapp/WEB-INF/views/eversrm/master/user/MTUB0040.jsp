...
<e:ui locale="${ses.countryCd}" lang="${ses.langCd}" dateFmt="${ses.dateFormat}">
	<script type="text/javascript">
        ...
        function search() {
            ...
            store.setGrid([grid]);
            store.load(baseUrl + 'mtub0040_doSearch.so', function() {
	...
	<e:window id="MTUB0040" onReady="init" initData="${initData}" title="${fullScreenName}" breadCrumbs="${breadCrumb }">
		...
		<e:gridPanel id="grid" name="grid" width="100%" height="fit" readOnly="${param.detailView}" gridType="${_gridType}" />
