...
<e:ui locale="${ses.countryCd}" lang="${ses.langCd}" dateFmt="${ses.dateFormat}">
	 ...
	 <script type="text/javascript">
	    ...
	    var grid;
	    var baseUrl = "/nhepro/CITI/CITR0020/";
					...
					switch (colIdx) {
						case "ITEM_REQ_NO":
							param = {
								...
								detailView: grid.getCellValue(rowIdx, "PROGRESS_CD") == "300" ? false : true,
								PROGRESS_CD: grid.getCellValue(rowIdx, "PROGRESS_CD")
							};

							everPopup.openPopupByScreenId('CITA0021', 950, 785, param);
							break;
		...
		function doSearch() {
			...
			store.setGrid([grid]);
			store.load(baseUrl + "citr0020_doSearch.so", function() {
	...
	<e:window id="CITR0020" onReady="init" initData="${initData}" title="${fullScreenName}" breadCrumbs="${breadCrumb }">
