...
<e:ui locale="${ses.countryCd}" lang="${ses.langCd}" dateFmt="${ses.dateFormat}">
    <script type="text/javascript">
        ...
        function init(){
            ...
            grid.cellClickEvent(function(rowIdx, colIdx, value) {
                ...
                if(colIdx === "VC_NO") {
                    ...
                    everPopup.openPopupByScreenId("SETR0041", 860, 750, param);
                }
            });
        }
        ...
        function doSearch() {
            ...
            store.setGrid([grid]);
            store.load(baseUrl + "setr0040_doSearch.so", function () {
        ...
        function doSave() {
            ...
            EVF.confirm("${msg.M0021}", function () {
                store.doFileUpload(function() {
                    ...
                    store.load(baseUrl + "setr0040_doSave.so", function() {
    ...
    <e:window id="SETR0040" onReady="init" initData="${initData}" title="${fullScreenName}" breadCrumbs="${breadCrumb }">
