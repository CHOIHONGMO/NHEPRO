...
public class DocNumService extends BaseService {
	...
	public String getDocNumber(String companyCd, String docType) throws Exception {
		...
		/**
		 * 2020.12.24 : 농협중앙회 요청으로 인해 문서번호 고객사별 채번 규칙 제외
