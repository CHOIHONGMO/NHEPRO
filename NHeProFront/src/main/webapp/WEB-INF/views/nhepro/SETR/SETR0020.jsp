...
<e:ui locale="${ses.countryCd}" lang="${ses.langCd}" dateFmt="${ses.dateFormat}">
    <script type="text/javascript">
        ...
        function init() {
            ...
            grid.cellClickEvent(function(rowIdx, colIdx) {
                ...
                if(colIdx == "SUBJECT") {
                    ...
                    everPopup.openPopupByScreenId("SETR0021", 1000, 700, param);
        ...
        function doSearch() {
            ...
            store.setGrid([grid]);
            store.load(baseUrl + "setr0020_doSearch.so", function() {
    ...
    <e:window id="SETR0020" initData="${initData}" onReady="init" title="${fullScreenName}" breadCrumbs="${breadCrumb }">
