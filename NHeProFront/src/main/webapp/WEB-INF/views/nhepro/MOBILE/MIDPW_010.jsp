...
<script>
    ...
    function confirm() {
        var url = "/nhepro/MOBILE/MIDPW_010_doSearch.so";
        var param = {
            USER_NM: $('#USER_NM').val(),
            EMAIL: $('#EMAIL').val()
        };
        $.post(url, param, function (data) {
            if(data.responseCode == 'success') {
                var url = "/nhepro/MOBILE/MIDPW_020/view.so";
                var param = {
                ...
                return alert("이름 또는 이메일을 다시 확인하여 주시기 바랍니다."); // 이름 또는 이메일을 다시 확인하여 주시기 바랍니다.
    ...
    function sendPw() {
        var url = "/nhepro/MOBILE/MIDPW_010_doSendPw.so";
        var param = {
            USER_ID: $('#USER_ID').val(),
            EMAIL: $('#EMAIL2').val()
        };
        $.post(url, param, function (data) {
            if(data.responseCode == 'success') {
                var url = "/nhepro/MOBILE/MIDPW_030/view.so";
                var param = {
                    EMAIL: data.EMAIL
                };
