...
<script>
    ...
    function resetPassword() {
        ...
        var url = "/nhepro/MOBILE_NHPT/MPTIDPW_040_resetPassword.so";
        var param = {
            USER_ID: '${USER_ID}',
        ...
        $.post(url, param, function (data) {
            if(data.responseCode == 'success') {
                alert("성공적으로 변경되었습니다."); // 성공적으로 변경되었습니다.
                mobileHome();
            } else if(data.responseCode == 'fail') {
                return alert("최근 사용한 동일한 비밀번호는 사용할 수 없습니다."); // 최근 사용한 동일한 비밀번호는 사용할 수 없습니다.
            }
        }, "json");
    }
    ...
    function chkPwd(str){
        ...
        for(var i=0; i < str.length; i++) {
			...
			if(SamePass_0 > 2) {
				return EVF.alert("동일문자를 3번 이상 사용할 수 없습니다.");  // 동일문자를 3번 이상 사용할 수 없습니다.
			}
        ...
        if(SamePass_1 > 1 || SamePass_2 > 1 ) {
            alert("연속된 문자열(123 또는 321, abc, cba 등)을 3자 이상 사용 할 수 없습니다."); // 연속된 문자열(123 또는 321, abc, cba 등)을 3자 이상 사용 할 수 없습니다.
            return false;
        }
