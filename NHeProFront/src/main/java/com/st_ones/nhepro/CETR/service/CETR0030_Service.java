...
import com.st_ones.nhepro.CETR.CETR0030_Mapper;
 ...
 ******************************************************************************
 * </pre>
 * @File Name : CETR0030_Service.java
 * @date 2018. 01. 30.
 * @version 1.0
 */

@Service(value = "CETR0030_Service")
public class CETR0030_Service extends BaseService {

    @Autowired MessageService msg;
    @Autowired CETR0030_Mapper cetr0030_mapper;
     ...
     */
    public List<Map<String, Object>> cetr0030_doSearch(Map<String, String> param) {
        return cetr0030_mapper.cetr0030_doSearch(param);
    }
     ...
     */
    public Map<String, Object> cetr0031_doSearchNoticeInfo(Map<String, String> param) throws Exception {
        Map<String, Object> rtnMap = cetr0030_mapper.cetr0031_doSearchNoticeInfo(param);
        ...
        if (param.get("detailView").equals("true")) {
            ...
            cetr0030_mapper.cetr0031_doSaveCount(rtnMap);
        }
    ...
    public Map<String, String> cetr0031_doSave(Map<String, String> formData) throws Exception {
        ...
        if(noticeNum.equals("")) {
            ...
            cetr0030_mapper.cetr0031_doInsert(formData);
        }
        else {

            largeTextService.saveLargeText(noticeTextNum, formData.get("NOTICE_CONTENTS"));

            cetr0030_mapper.cetr0031_doUpdate(formData);
        }
    ...
    // 삭제
    @Transactional(propagation = Propagation.REQUIRED, rollbackFor = Exception.class)
    public String cetr0031_doDelete(Map<String, String> formData) throws Exception {
        Map<String, Object> param = new HashMap<>();

        param.put("NOTICE_NUM", formData.get("NOTICE_NUM"));

        cetr0030_mapper.cetr0031_doDelete(param);
