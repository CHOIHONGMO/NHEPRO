    ...
    function doSave() {
        ...
        $.post(url, $('#form').serialize(), function (data) {
            if(data.responseCode == 'success') {
                location.href = "/nhepro/MOBILE/MAGG_040/view.so";
            } else {
    ...
    <section class="contents sign-up">
        ...
        <section class="fbox sign-up">
            <fieldset class="ins">
                ...
                <div class="t-row">
                    <div class="t-cell01"><label for="EMAIL"><i class="title required"></i>E-mail</label></div>
                    <div class="t-cell02">
...
<script>
    ...
    $(document).ready(function () {
        ...
        /*var now_year = parseInt('${NOW_YEAR}') - 14;
        var birth_date1 = "";
        for (var i = now_year - (100 - 14); i <= now_year; i++) {
        ...
        */
        ...
        $('#overlap_btn').on('click', function () {
            ...
            var url = "/nhepro/MOBILE/userIdCheck.so";
            var param = {
                USER_ID: $('#USER_ID').val()
            };
            $.post(url, param, function (data) {
